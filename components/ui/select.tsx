  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        // taking an edge.
        "flex w-fit items-center justify-between gap-2 rounded-xl border border-muted-foreground/5 bg-wash/30 px-3 font-display text-sm font-medium tracking-[-0.022em] whitespace-nowrap cursor-pointer outline-none [transition:background-color_.25s_ease-in-out] motion-reduce:transition-none data-[size=default]:h-[34px] data-[size=sm]:h-8 enabled:hover:bg-wash/40 focus-visible:bg-wash/40 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary disabled:cursor-not-allowed disabled:opacity-40 data-[placeholder]:text-subtle-foreground aria-invalid:border-destructive *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-1.5 [&_svg:not([class*='size-'])]:size-5 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      {...props}
    >
