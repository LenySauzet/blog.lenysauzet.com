export const metadata = {
  title: 'Realtime PBR Lighting Models Explained',
  description:
    'A guide to realtime PBR lighting models explained, covering various techniques and tools for controlling and manipulating realtime PBR lighting models in a scene.',
  tags: ['PBR', 'lighting', 'blog'],
  date: '2026-02-02',
};
