export const metadata = {
  title: 'Mastering Signed Distance Fields in Shaders',
  description:
    'A guide to mastering signed distance fields in shaders, covering various techniques and tools for controlling and manipulating signed distance fields in a scene.',
  tags: ['signed distance fields', 'blog'],
  date: '2026-02-02',
};
