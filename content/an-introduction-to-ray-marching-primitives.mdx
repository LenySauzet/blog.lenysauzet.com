export const metadata = {
  title: 'An Introduction to Ray Marching Primitives',
  description:
    'An introduction to ray marching primitives, covering various techniques and tools for controlling and manipulating light in a scene.',
  tags: ['ray marching', 'blog'],
  date: '2024-02-02',
};
