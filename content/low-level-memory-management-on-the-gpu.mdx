export const metadata = {
  title: 'Low-Level Memory Management on the GPU',
  description:
    'A guide to low-level memory management on the GPU, covering various techniques and tools for controlling and manipulating low-level memory management on the GPU in a scene.',
  tags: ['gpu', 'blog'],
  date: '2026-02-02',
};
