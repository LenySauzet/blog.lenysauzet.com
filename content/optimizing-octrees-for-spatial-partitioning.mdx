export const metadata = {
  title: 'Optimizing Octrees for Spatial Partitioning',
  description:
    'A guide to optimizing octrees for spatial partitioning, covering various techniques and tools for controlling and manipulating octrees for spatial partitioning in a scene.',
  tags: ['octrees', 'spatial partitioning', 'blog'],
  date: '2026-02-02',
};
